...
from astrodendro import six
from astrodendro.structure import Structure
from astrodendro.flux import UnitMetadataWarning
from astrodendro.progressbar import AnimatedProgressBar
...
class PPVStatistic(SpatialBase):
    ...
    def flux(self):
        ...
        """
        from astrodendro.flux import compute_flux
